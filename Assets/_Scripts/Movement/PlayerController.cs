...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void CheckCollisions()
        {
            ...
            //ground becomes ceiling if you invert gravity
            if(invertGravity) (ceilingHit, groundHit) = (groundHit, ceilingHit);
        ...
        private void ApplyMovement()
        {
            ...
            _rb.velocity = invertGravity ? new Vector2(_frameVelocity.x, -_frameVelocity.y) : _frameVelocity;
